  ...
  return (
    ...
    <SafeAreaView>
      ...
      <Pressable
        ...
        <View style={{marginHorizontal:15, marginTop:10, flexDirection:"row", alignItems:"center", justifyContent:"space-between"}} >
            <View>
              ...
              >
                ...
                <View style={{backgroundColor:"#17b169", paddingHorizontal:6, paddingVertical:6, borderRadius:6, marginLeft:70}}>
        ...
        <Text
          ...
          <Text style={{borderColor:"#e0e0e0", borderWidth:3, height:1, marginTop:15}} />
          <Amenities/>
          <Text style={{borderColor:"#e0e0e0", borderWidth:3, height:1, marginTop:15, marginBottom:50}} />
    ...
    style={{backgroundColor:"#6cb4ee", position:"absolute", bottom:20, padding:15, width:370, marginHorizontal:10, }} >
