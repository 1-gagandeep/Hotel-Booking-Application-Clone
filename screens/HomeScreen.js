...
const HomeScreen = () => {
    ...
    const customButton = (onConfirm) => {
      return(
        ...
        onPress={onConfirm}
        style={{
          container:{width:300, marginHorizontal:30},
          text: {fontSize:20},
        }}
        primary
        title="Submit"
  ...
  return (
      ...
      <Header/>
        ...
        <ScrollView>
            <View style={{margin:20, borderColor:"#ffc72c", borderWidth:3, borderRadius:6}} >
                ...
                style={{flexDirection:"row", alignItems:"center", gap:10, paddingHorizontal:10, borderColor:"#ffc72c", borderWidth:2, paddingVertical:15}} >
            ...
            >
              ...
              />
                ...
                style={{  paddingHorizontal:10, borderColor:"#ffc72c", borderWidth:2, paddingVertical:15, backgroundColor:"#2a52be"}}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} >
              <Pressable style={{width:200, height:150, marginTop:10, backgroundColor:"#003580", borderRadius:10, padding:20,  marginHorizontal:10}} >
    ...
    <BottomModal 
    swipeThreshold={200}
    onBackdropPress={() => setModalVisiable(!modalVisible)}
    ...
    onHardwareBackPress={() => setModalVisiable(!modalVisible)}
    visible={modalVisible}
    onTouchOutside={() => setModalVisiable(!modalVisible)}
    >
      <ModalContent style={{height:310}}>
        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", marginVertical:15}}>
          ...
          <Pressable style={{flexDirection:"row", alignItems:"center", gap:10}} >
            ...
            <Pressable>
              <Text style={{textAlign:"center", fontSize:20, fontWeight:500, paddingHorizontal:6}} >{rooms}</Text>
            </Pressable>
        ...
        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", marginVertical:15}}>
          ...
          <Pressable style={{flexDirection:"row", alignItems:"center", gap:10}} >
            ...
            <Pressable>
              <Text style={{textAlign:"center", fontSize:20, fontWeight:500, paddingHorizontal:6}} >{adults}</Text>
            </Pressable>
        ...
        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between", marginVertical:15}}>
          ...
          <Pressable style={{flexDirection:"row", alignItems:"center", gap:10}} >
            ...
            <Pressable>
              <Text style={{textAlign:"center", fontSize:20, fontWeight:500, paddingHorizontal:6}} >{children}</Text>
            </Pressable>
