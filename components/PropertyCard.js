  ...
  return (
    <ScrollView>
      ...
      style={{margin:15, flexDirection:"row", backgroundColor:"white"}} >
        <View>
            <Image style={{height:height/3, width:width-250}} source={{uri:property.image}} />
        </View>
        ...
        <View style={{padding:10}}>
            ...
            <Text style={{width:180, marginTop:6, color:"gray", fontWeight:"bold"}} > {property.address.length > 50 ? property.address.substr(0,50) : property.address} </Text>
